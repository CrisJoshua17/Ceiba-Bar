...
public class RabbitConfig {
    ...
    @Bean
    public Binding bindingOrderCreated(Queue orderCreatedQueue, TopicExchange sagaExchange) {
        return BindingBuilder.bind(orderCreatedQueue).to(sagaExchange).with("order.created");
    }
