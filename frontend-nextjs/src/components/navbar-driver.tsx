...
export function NavbarDriver() {
  ...
  const menuItems = [
    { name: 'Entregas Activas', path: '/drivers/deliveries', icon: Truck },
    { name: 'Historial', path: '/drivers/history', icon: History },
  ...
  return (
    <>
      <header className="sticky top-0 z-40 w-full bg-ceiba-paper border-b border-ceiba-line shadow-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <Link href="/drivers/dashboard" className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden lg:flex items-center gap-3">
              <div className="text-right">
                <p className="text-xs font-bold text-ceiba-ink">{user?.name || 'Repartidor'}</p>
                <p className="text-[10px] text-ceiba-ink/60">Repartidor Autorizado</p>
              </div>
              <Button
                size="icon"
                variant="ghost"
      ...
      {/* Left Sidebar (Sheet) for Driver Panel */}
          ...
          <SheetHeader className="pb-4 border-b border-ceiba-line">
            <div className="flex flex-col items-center gap-3 mt-4 text-center">
              ...
              <div>
                ...
                <p className="text-xs text-ceiba-ink/60 mt-0.5">
                  Panel de Reparto
                </p>
              </div>
            </div>
